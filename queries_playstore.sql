...
SELECT app_name, reviews FROM analytics WHERE rating>=4.8 DESC limit 1;
...
SELECT app_name, min_installs,rating FROM analytics WHERE rating IS NOT NULL AND min_installs<=50 ORDER BY rating DESC, min_installs;
...
AS Proportion FROM analytics 
WHERE min_installs >=100000 
ORDER BY (min_installs/reviews) LIMIT 1;